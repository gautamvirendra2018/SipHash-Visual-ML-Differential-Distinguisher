...
# ---------------------------------------------------------
# SipHash-c-d for 64-bit message
# ---------------------------------------------------------
def siphash_c_d_64(m0, k0, k1, c, d):
...
# ---------------------------------------------------------
# Generate 64-bit delta with given Hamming weight
# ---------------------------------------------------------
def generate_delta_64(hw):
...
def generate_dataset(n_samples, c, d, delta, seed=0):
    ...
    for _ in range(n_samples):
        ...
        # ----- real differential -----
        t1 = siphash_c_d_64(m0, k0, k1, c, d)

        # Introducing the differential in the second block
        t2 = siphash_c_d_64(m0^delta, k0, k1, c, d)
...
if __name__ == "__main__":
    ...
    n_samples = 1_15_536
    out_dir = "siphash_datasets_1block_tag"
    ...
    for c, d in [(1, 0),(1, 1),(1, 2),(2, 0),(2, 1),(3, 0)
            ...
            for hw in range(1, 3): # Set Hamming Weight to create input Delta
                ...
                delta = generate_delta_64(hw)

                #for pos in [0, 1]:  # 0 = first block, 1 = second block
