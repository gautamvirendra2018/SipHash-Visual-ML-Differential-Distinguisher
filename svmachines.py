...
def train_one_round(train_dir, test_dir):
    # No transformation, just raw tensors
...
result_file = os.path.join("result", "result_svm.txt")
...
with open(result_file, "w", encoding="utf-8") as f:
    if not os.path.exists("results_svm.txt") or os.path.getsize("results_svm.txt") == 0:
